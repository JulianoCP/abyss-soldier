...
{
    VRAMIndex += CharacterInit(EnemyReference, &EnemyImage, GetSafeRandomScreenPosition(), MakeAttribute(FIX16(INIT_ENEMY_SPEED), FIX16(INIT_ENEMY_HEALTH)), PAL_ENEMY, VRAMIndex);
    return VRAMIndex;
}
